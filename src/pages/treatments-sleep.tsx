...
const PROCESS = [
  ...
  },
  {
    ...
    title: '보호자 동행 귀가',
    duration: '귀가 후 24시간',
    desc: '진정 후 24시간은 운전 및 중요한 의사결정을 금지합니다.\n보호자 동행을 원칙으로 하며, 다음날까지 컨디션 체크를 진행합니다.',
...
const WHY_US = [
  ...
  },
  {
    ...
    emoji: '⏱️',
    title: '한 번 누우면\n끝나는 통합 진료',
    desc: '여러 진료를 최소한의 방문으로 끝내고 싶은 분께 최적.\n임플란트·신경치료·발치까지\n한 번의 진정으로 완료 가능합니다.',
  },
]
...
export const SleepTherapyTreatmentPage = ({
  ...
  return (
    <>
      ...
      {(() => { const t = getTldr('sleep-therapy'); return t ? <TldrBox label={t.label} summary={t.summary} bullets={t.bullets} cta={t.cta} reviewer={t.reviewer} /> : null })()}
