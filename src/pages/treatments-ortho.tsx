...
export const OrthoTreatmentPage = ({
  ...
  return (
    <>
        ...
        <div class="relative max-w-[1440px] mx-auto px-6 lg:px-12">
          <div class="max-w-4xl fade-in">
            ...
            <h1 class="display font-black tracking-tight leading-[0.95] mb-10" style="font-size:clamp(3rem, 8vw, 7.5rem); color:#fdfbf7; text-shadow: 0 4px 24px rgba(0,0,0,0.6), 0 1px 3px rgba(0,0,0,0.8);">
              ...
              <span class="block not-italic" style="color:var(--gold); text-shadow: 0 4px 24px rgba(201,168,118,0.3), 0 1px 3px rgba(0,0,0,0.6);">일상 그대로</span>
      ...
      {(() => { const t = getTldr('ortho'); return t ? <TldrBox label={t.label} summary={t.summary} bullets={t.bullets} cta={t.cta} reviewer={t.reviewer} /> : null })()}
        ...
        <section class="py-24 bg-cream">
          <div class="max-w-[1200px] mx-auto px-6 lg:px-12">
            <div class="flex justify-between items-end mb-12 fade-in">
              ...
              <a href="/before-after?treatment=ortho" class="link-underline display not-italic">전체 보기 →</a>
            </div>
