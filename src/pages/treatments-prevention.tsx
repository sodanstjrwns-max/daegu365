...
export const PreventionTreatmentPage = ({
  ...
  return (
    <>
      ...
      <section class="relative bg-brown-950 text-ivory pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative">
          ...
          <h1 class="display font-black tracking-tight leading-[0.95] mb-10" style="font-size:clamp(3rem, 8vw, 7.5rem); color:#fdfbf7; text-shadow: 0 4px 24px rgba(0,0,0,0.6), 0 1px 3px rgba(0,0,0,0.8);">
            가장 좋은 치료는,<br/><span class="not-italic" style="color:#c9a876; text-shadow: 0 4px 24px rgba(201,168,118,0.3), 0 1px 3px rgba(0,0,0,0.8);">치료가 없는 것.</span>
          </h1>
      ...
      {(() => { const t = getTldr('prevention'); return t ? <TldrBox label={t.label} summary={t.summary} bullets={t.bullets} cta={t.cta} reviewer={t.reviewer} /> : null })()}
      <section class="py-24 lg:py-32 bg-ivory">
        <div class="max-w-6xl mx-auto px-6 lg:px-12">
          <div class="grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            <div class="lg:col-span-5">
              <div class="section-label mb-6">WHAT IS · 01</div>
              <h2 class="whatis-headline">예방은,<br/><span class="t-gold not-italic">치료보다 큰 의료</span>입니다.</h2>
            </div>
      ...
      <section id="programs" class="py-24 lg:py-32 bg-cream scroll-mt-24">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
          <div class="text-center mb-16"><div class="section-label mb-6">PROGRAMS · 02</div><h2 class="t-display">예방 <span class="t-gold not-italic">6프로그램.</span></h2></div>
      ...
      <section class="py-24 lg:py-32 bg-ivory">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
          <div class="text-center mb-16"><div class="section-label mb-6">RECALL · 03</div><h2 class="t-display">맞춤 <span class="t-gold not-italic">리콜.</span></h2></div>
      ...
      <section class="py-24 lg:py-32 bg-cream">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
          <div class="text-center mb-16"><div class="section-label mb-6">COMPARE · 04</div><h2 class="t-display">치료 vs <span class="t-gold not-italic">예방.</span></h2></div>
      ...
      <section class="relative py-24 lg:py-32 text-ivory overflow-hidden" style="background:var(--brown-950);">
        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-12 text-center relative">
          ...
          <h2 class="contact-headline">아프기 전에,<br/><span class="not-italic">365일 곁에.</span></h2>
