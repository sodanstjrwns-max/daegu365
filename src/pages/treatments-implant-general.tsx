...
const WHY_US = [
  ...
  },
  {
    ...
    title: '평생 임플란트 보증',
    // PPT 모바일 슬라이드 118 — 문구변경 + 줄바꿈 + 괄호문장 회색 작게
    desc: (
      <>
        모든 부작용 · 파절 · 소실에 대해<br />
        평생 무상 재치료 · 보수를 보장합니다.<br />
        <span class="text-xs text-brown-400">(환자 부주의에 의한 파절,소실 제외)</span><br />
        단 한 번의 시술로 평생의 안심을.
      </>
    ),
    meta: '픽스처 5년 · 상부 평생',
...
export const ImplantGeneralTreatmentPage = ({
  ...
  return (
    <>
        ...
        <div class="relative max-w-[1440px] mx-auto px-6 lg:px-12">
          <div class="max-w-4xl fade-in">
            ...
            <h1 class="display font-black tracking-tight leading-[0.95] mb-10" style="font-size:clamp(3rem, 8vw, 7.5rem); color:#fdfbf7; text-shadow: 0 4px 24px rgba(0,0,0,0.6), 0 1px 3px rgba(0,0,0,0.8);">
              ...
              <span class="block not-italic" style="color:var(--gold); text-shadow: 0 4px 24px rgba(201,168,118,0.3), 0 1px 3px rgba(0,0,0,0.6);">합리적 선택의</span>
      ...
      {(() => { const t = getTldr('implant-general'); return t ? <TldrBox label={t.label} summary={t.summary} bullets={t.bullets} cta={t.cta} reviewer={t.reviewer} /> : null })()}
      ...
      <section class="py-24 lg:py-32 bg-brown-950 text-ivory text-center">
        <div class="max-w-3xl mx-auto px-6 lg:px-12">
          ...
          <h2 class="display text-4xl lg:text-6xl font-black tracking-tight mb-6 leading-tight">
            평생 가는 임플란트를<br/>
            <span class="not-italic text-gold">합리적으로</span> 시작하세요
          </h2>
